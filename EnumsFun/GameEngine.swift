...
class GameEngine {
    ...
    init(player1: String, player2: String) {
        let player1Hand = Hand(cards: self.deck.playerDecks.0)
        let player2Hand = Hand(cards: self.deck.playerDecks.1)
    ...
    func gameOver() -> Bool {
        return player1.hand.cards.count == 0 || player2.hand.cards.count == 0 ? true : false
    }
